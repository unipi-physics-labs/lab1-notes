\begin{Verbatim}[label=\makebox{\href{https://github.com/unipi-physics-labs/lab1-notes/tree/main/snippy/sample_stat4.py}{https://github.com/.../sample\_stat4.py}},commandchars=\\\{\}]
...
[Output]
(np.float64(0.00977265669910497), np.float64(0.9988357867259919))
(np.float64(1000000000.0097727), np.float64(0.9988357862468052))
\end{Verbatim}
