\begin{Verbatim}[label=\makebox{\href{https://github.com/unipi-physics-labs/lab1-notes/tree/main/snippy/sample_stat_welford.py}{https://github.com/.../sample\_stat\_welford.py}},commandchars=\\\{\}]
...
[Output]
(2.488888888888889, np.float64(0.18086213288334052))
(np.float64(1000000002.4888889), np.float64(0.18086214309939616))
\end{Verbatim}
