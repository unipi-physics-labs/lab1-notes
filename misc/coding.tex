...
\newcommand{\byte}[1]{\framebox{\texttt{\hbox{#1}}}}
...
\newcommand{\pybuiltin}[1]{\href{https://docs.python.org/3/library/functions.html\##1}{\pyfunc{#1}}}
...
% Operating systems.
\newcommand{\windows}{Microsoft Windows}
\newcommand{\dos}{Microsoft DOS}
