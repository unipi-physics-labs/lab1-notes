\chapter{Leggi di potenza ed esponenziali}

Interpretare un grafico alla prima occhiata \`e senza dubbio uno dei superpoteri
che tutti i fisici sperimentali dovebbrero avere. Rappresentare graficamente i
dati in forma opportuna permette spesso di identificare propriet\`a interessanti
che non sono immedietamente ovvie da una tabella o una lista di numeri, ma cogliere
queste propriet\`a \`e una sorta di arte che si acquisice con l'esperienza.

In questa sezione utilizzeremo delle serie di dati di vario genere, liberamente
disponibili, per acquisire familiarit\`a con le scale logaritmiche e con le
due famiglie di funzioni---le leggi di potenza e gli esponenziali---che si possono
linearizzare con questo tipo di scale.

Arrivati alla fine, dovreste essere in grado di stimare ad occhio la normalizzazione
e l'indice di una legge di potenza, o la costante di tempo di un espoenenziale,
e di fare stime ragionevoli delle grandezze derivate rilevanti, e.g., estrapolare
un modello al di fuori del suo supporto. Sforzatevi di svolgere gli esercizi
senza l'aiuto di calcolatrici o computer---per quanto possibile in testa, o al
massimo con carta e penna. Pu\`o sembrare difficile all'inizio, ma ne vale la pena!
...
ai \foreign{R.E.M}, con 20~milioni di copie. (Le lettrici più attente noteranno
che i gruppi preferiti dall'autore originale dell'esercizio sono annotati con
delle piccole frecce di riferimento; il fatto che i \foreign{Beach Boys} siano
oltre la centesima posizione è un misfatto che grida vendetta, ma tant'è\ldots)
...
\pgffigone{riaa}{
  ...
  (Dati liberamente disponibili a \url{https://www.riaa.com/gold-platinum}.)}
...
potenza, come illustrato in figura~\ref{fig:moby_dick}.
...
190313~occorrenze.
Il testo integrale del romanzo, in inglese, è liberamente disponibile
a \url{http://bioinf.gen.tcd.ie/pol/moby.dick.txt}.}

Si stimino la normalizzazione e l'indice della legge di potenza. \`E possibile
fornire una stima del numero totale di parole da cui è composto il romanzo?
...
%I dati sono liberamente disponibili a~\url{https://tools.ssdc.asi.it/CosmicRays/}.}

Si stimino la normalizzazione e l'indice della legge di potenza.
...
\begin{exercise}\label{ex:atmosfera_exp}
...
rappresentato dalla linea tratteggiata.
...
Si sviluppi un semplice modellino Fisico
...
\begin{center}
    \input{figures/atmosfera_densita.pgf}
\end{center}
...
Consumo annuo globale di energia (in Wh) dal 1800 al 2010. I dati sono
liberamente disponibili a
...
grandezza (ovvero una decade) nei 100~anni tra il 1900 ed il 2000, per un tempo
caratteristico di
\begin{align*}
...
I dati sono liberamente disponibili a \url{ https://ourworldindata.org/plastic-pollution}.}
